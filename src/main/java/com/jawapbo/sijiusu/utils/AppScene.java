...
public enum AppScene {
    ...
    ADMIN_DASHBOARD_ACADEMIC_FACULTY_ID_DEPARTMENT("admin/admin-dashboard-academic-faculty-id-major", "Admin Dashboard Academic"),
    ADMIN_DASHBOARD_ACADEMIC_FACULTY_ID_DEPARTMENT_ID_CREATE("admin/admin-dashboard-academic-faculty-id-major-id-create", "Admin Dashboard Academic"),
    ADMIN_DASHBOARD_ACADEMIC_FACULTY_ID_DEPARTMENT_ID_EDIT("admin/admin-dashboard-academic-faculty-id-major-id-edit", "Admin Dashboard Academic"),
    ADMIN_DASHBOARD_ACADEMIC_FACULTY_ID_DEPARTMENT_ID_ROOM("admin/admin-dashboard-academic-faculty-id-major-id-room", "Admin Dashboard Academic"),
