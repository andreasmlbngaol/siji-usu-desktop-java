...
public enum AppScene {
    ...
    ADMIN_DASHBOARD_ACADEMIC_ID_DEPARTMENT("admin/admin-dashboard-academic-faculty-id-department", "Admin Dashboard Academic"),
    ADMIN_DASHBOARD_ACADEMIC_ID_DEPARTMENT_ID_CREATE("admin/admin-dashboard-academic-faculty-id-department-id-create", "Admin Dashboard Academic"),
    ADMIN_DASHBOARD_ACADEMIC_ID_DEPARTMENT_ID_EDIT("admin/admin-dashboard-academic-faculty-id-department-id-edit", "Admin Dashboard Academic"),
    ADMIN_DASHBOARD_ACADEMIC_ID_DEPARTMENT_ID_ROOM("admin/admin-dashboard-academic-faculty-id-department-id-room", "Admin Dashboard Academic"),
